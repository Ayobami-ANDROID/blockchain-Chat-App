...
//             setFriendMsg(read)
//         } catch (error) {
//             setError("currently have no message")
//         }
//     }
...
//     return(
//         <ChatAppContext.Provider value={{readMessage,createAccount,addFriends,sendMessage,readUser,connectWallet,chechIfWalletConnected,account,userName,friendLists,friendMsg,userList,loading,error,currentUserName,currentUserAddress}}>
//             {children}
